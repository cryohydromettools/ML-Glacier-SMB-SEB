...
out_nc = dir_results / f"ME_simulated_Artesonraju_NN_{target}.nc"
...
out_ds["ME_mean"] = smb_mean
out_ds["ME_std"]  = smb_std
...
# Metadata
# ============================================================
out_ds["ME_mean"].attrs.update({
    "long_name": "Surface energy balance (NN ensemble mean)",
    "units": "W m**{-2}"
})

out_ds["ME_std"].attrs.update({
    "long_name": "Surface energy balance uncertainty (NN ensemble std)",
    "units": "W m**{-2}"
})

out_ds.attrs["description"] = (
    "Surface energy balance simulated using an ensemble of "
...
print("\n✅ ME simulation completed with NN emulators")
