...
out_nc = dir_results / f"ME_simulated_Artesonraju_{target}.nc"
...
out_ds["ME_mean"].attrs.update({
    "long_name": "Surface energy balance (ML ensemble mean)",
    "units": "W m**{-2}"
})

out_ds["ME_std"].attrs.update({
    "long_name": "Surface energy balance uncertainty (ML ensemble std)",
    "units": "W m**{-2}"
})
